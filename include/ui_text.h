 ...
 *
 * Available widgets:
 * - <text_heading>: Section headings, large text (montserrat_20 + header_text_color)
 * - <text_body>:    Standard body text (montserrat_16 + text_primary)
 * - <text_small>:   Small/helper text (montserrat_10 + text_secondary)
 *
 ...
 * Registers custom widgets: text_heading, text_body, text_small
 *
